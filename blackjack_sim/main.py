...
new_variable = 100
#this variable has been added so that it can be updated on git
...
# simulate
cpus = multiprocessing.cpu_count() #corecount
...
print('amount of wins = %d' % win)
print('amount of ties = %d' % draw)
print('amount of losses = %d' % lose)

winpercent = ((win/timestorun)*100)
drawpercent = ((draw/timestorun)*100)
losepercent = ((lose/timestorun)*100)

print('After running the simulator a total of %d times' % timestorun)
print('You had a total win percentage of %d' % winpercent)
print('You had a total draw percentage of %d' % drawpercent)
print('You had a total loss percentage of %d' % losepercent)
